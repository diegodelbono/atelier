		...
		<div class="row product-single__info">
			...
			<div class="product-single__details">
				...
				<div class="tab">
					...
					<div class="tab__nav">
						<div id="tab-options" 	class="tab__item js-tab-item">Options</div>
						<div id="tab-details" 	class="tab__item js-tab-item">Details</div>
						<div id="tab-download" 	class="tab__item js-tab-item">Downloads</div>
						<div id="tab-inquirer" 	class="tab__item js-tab-item">
							<div class="button-outline">Inquire</div>
						</div>
					</div>

					<div class="tab__container">			
						<div id="tab-options" class="tab__item tab__item--mobile js-tab-item">Options</div>		
						<div id="tab-options-content" class="tab__content js-tab-content">
						...
						<div id="tab-details" 	class="tab__item tab__item--mobile js-tab-item">Details</div>
						<div id="tab-details-content" 	class="tab__content js-tab-content">
							<?php echo $details; ?>
							
						</div>
						<div id="tab-download" 	class="tab__item tab__item--mobile js-tab-item">Downloads</div>
						<div id="tab-download-content" 	class="tab__content js-tab-content">
							<?php if($spec || $wiring){ ?>
						...
						<div id="tab-inquirer" 	class="tab__item tab__item--mobile js-tab-item">
							<div class="button-outline">Inquire</div>
						</div>
						<div id="tab-inquirer-content" 	class="tab__content js-tab-content">
